        ...
        if sender != 'Kahzam#8492':
            ...
            if checkmessage == "!google":
                ...
                try:
                    ...
                    await client.add_reaction(mgs[0],'b_U:534863131978104853')
                    await client.add_reaction(mgs[0],'g_U:534863064487428106')
                    await client.add_reaction(mgs[0],'r_U:534827521925971987')
                    await client.add_reaction(mgs[0],'y_U:534863097417039902')
                except Exception as e:
                    msg = e
                finally:
                    pass
