        ...
        if sender != 'Kahzam#8492':
            ...
            if checkmessage == "!google":
                ...
                try:
                    ...
                    await client.add_reaction(mgs,'b_U:534863131978104853')
                    await client.add_reaction(mgs,'g_U:534863064487428106')
                    await client.add_reaction(mgs,'r_U:534827521925971987')
                    await client.add_reaction(mgs,'y_U:534863097417039902')
                except Exception as e:
                    msg = e
                finally:
                    pass
